                      ...
                      return (
                        <tr key={order.id} className="border-b border-neutral-50 last:border-0 align-top hover:bg-[#FAFAFA] transition-colors">
                          <td className="px-5 py-4">
                            ...
                            {order.customer_phone && buildWhatsAppUrl(order.customer_phone) && (
                              <a href={buildWhatsAppUrl(order.customer_phone)} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1 text-xs text-green-600 font-medium mt-0.5 hover:text-green-700">

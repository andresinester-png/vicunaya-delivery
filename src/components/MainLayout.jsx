...
export default function MainLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: '#f8f9ff', paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
      {/* ── Header blanco ── */}
      <header
        className="sticky top-0 z-40 shrink-0"
        style={{ background: '#ffffff', boxShadow: '0 1px 0 rgba(15,23,42,0.08)', paddingTop: 'env(safe-area-inset-top, 0px)' }}
      >
        ...
        <div style={{
          ...
          {/* Izquierda: MapPin + Kyvra + subtítulo */}
          <Link
            to="/"
          ...
          >
            <div style={{ transform: `scale(${shrunk ? 0.78 : 1})`, transition: 'transform 0.3s ease', transformOrigin: 'left center', flexShrink: 0, display: 'flex' }}>
              <MapPin size={22} color="#0D9488" strokeWidth={2.3} />
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', minWidth: 0 }}>
              <span style={{ color: '#0F172A', fontWeight: 800, fontSize: shrunk ? 13 : 15, lineHeight: 1.2, fontFamily: "'Plus Jakarta Sans', sans-serif", transition: 'font-size 0.3s ease' }}>
                Kyvra
              </span>
              <span style={{
                color: 'rgba(15,23,42,0.55)', fontSize: 11.5, fontWeight: 500,
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '50%', background: 'rgba(15,23,42,0.07)',
        ...
        {title && (
          <div style={{
            ...
            <h1 style={{ color: '#0F172A', fontWeight: 900, fontSize: 20, letterSpacing: '-0.02em', margin: 0 }}>
              {title}
            </h1>
          </div>
        )}
